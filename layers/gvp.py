...
# model = GVP(
#     dim_vectors_in = 1024, // geometric vectors
#     dim_feats_in = 512, // scalar features input dimension
#     dim_vectors_out = 256, //geometric vectors output dimension
#     dim_feats_out = 512, // scalar features output dimension
#     vector_gating = True
# )
...
class GVP(nn.Module):
    def __init__(
        ...
        *,
        ...
        #linear transformations Wh and Wu in the diagram for geometric vectors
